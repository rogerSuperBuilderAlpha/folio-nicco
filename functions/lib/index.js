...
exports.healthCheck = exports.generateVideoThumbnail = void 0;
...
exports.generateVideoThumbnail = functions
    ...
    try {
        ...
        if (!videoId || !timestamp || !userId) {
            throw new functions.https.HttpsError('invalid-argument', 'Missing required parameters: videoId, timestamp, or userId');
        }
        ...
        // Verify ownership
        if ((videoData === null || videoData === void 0 ? void 0 : videoData.ownerUid) !== userId) {
            throw new functions.https.HttpsError('permission-denied', 'You do not have permission to edit this video');
        }
        // Validate timestamp is within video duration (if available)
        if ((videoData === null || videoData === void 0 ? void 0 : videoData.duration) && timestamp > videoData.duration) {
            throw new functions.https.HttpsError('invalid-argument', 'Timestamp exceeds video duration');
        }
        // Get video file URL from storage
        const videoUrl = (_a = videoData === null || videoData === void 0 ? void 0 : videoData.playback) === null || _a === void 0 ? void 0 : _a.mp4Url;
        if (!videoUrl) {
            throw new functions.https.HttpsError('not-found', 'Video file not found or not accessible');
        }
