...
export default function SignInPage() {
  ...
  useEffect(() => {
    ...
    if (user) {
      router.push('/onboarding'); // Let onboarding handle the redirect logic
    }
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Sign in to your Folio account and manage your portfolio." />
      </Head>
      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--color-bg)', padding: '24px' }}>
        <div className="card" style={{ width: '100%', maxWidth: '400px' }}>
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <h1 style={{ margin: '16px 0 8px', fontSize: '28px' }}>Welcome back</h1>
            <p style={{ margin: 0, color: 'var(--text-secondary)' }}>Sign in to your account</p>
          </div>
          ...
          <div style={{ textAlign: 'center', fontSize: 'var(--text-small-size)', color: 'var(--text-secondary)' }}>
            ...
            <Link href="/signup" style={{ color: 'var(--interactive)', fontWeight: 500 }}>
              Sign up
            </Link>
          </div>
        </div>
